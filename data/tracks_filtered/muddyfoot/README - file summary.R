### README - Muddyfoot tracking files ###

#01_muddyfoot_sub.rds
#locations that fell outside of the lake boundries filtered from the dataframe

#02_muddyfoot_sub.rds
...
#Add columns for individual's home range size and effective sample size
