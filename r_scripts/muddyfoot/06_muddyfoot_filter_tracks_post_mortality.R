...
message("Projection: ", ctmm::projection(muddyfoot_tels[[1]]))
...
saveRDS(pike_muddyfoot_tel, paste0(save_telem_path, "muddyfoot/pike_muddyfoot_tel_thinned_final.rds"))
saveRDS(perch_muddyfoot_tel, paste0(save_telem_path, "muddyfoot/perch_muddyfoot_tel_thinned_final.rds"))
saveRDS(roach_muddyfoot_tel, paste0(save_telem_path, "muddyfoot/roach_muddyfoot_tel_thinned_final.rds"))
...
pike_muddyfoot_tel <- readRDS(paste0(save_telem_path, "muddyfoot/pike_muddyfoot_tel_thinned_final.rds"))
...
# Option to reload if needed ------------------------------------------------
perch_muddyfoot_tel <- readRDS(paste0(save_telem_path, "muddyfoot/perch_muddyfoot_tel_thinned_final.rds"))

if (length(perch_muddyfoot_tel) > 0) {
  # Fit models using parallel processing -----------------------------------
  perch_cores <- ifelse(length(perch_muddyfoot_tel) > 15, 15, 3)
...
# Option to reload if needed ------------------------------------------------
roach_muddyfoot_tel <- readRDS(paste0(save_telem_path, "muddyfoot/roach_muddyfoot_tel_thinned_final.rds"))

if (length(roach_muddyfoot_tel) > 0) {
  # Fit models using parallel processing -----------------------------------
  roach_cores <- ifelse(length(roach_muddyfoot_tel) > 15, 15, 3)
