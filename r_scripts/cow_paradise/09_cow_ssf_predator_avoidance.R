...
perch_ssf_coefs <- read_csv(paste0(ssf_path, "cow_perch/perch_ssf_coefs.csv"))

write_csv(roach_ssf_coefs, paste0(ssf_path, "cow_roach/roach_ssf_coefs.csv"))
roach_ssf_coefs <- read_csv(paste0(ssf_path, "cow_roach/roach_ssf_coefs.csv"))
...
plot_ssf_coefs <- function(coef_df, species_label, y_limits = c(-3, 1)) {
...
ggsave(paste0(fig_path, "perch_ssf_pike_od_cow.pdf"), perch_ssf_plot,
       width = 8, height = 7, units = "cm", dpi = 300, device = "pdf")
ggsave(paste0(fig_path, "roach_ssf_pike_od_cow.pdf"), roach_ssf_plot,
       width = 8, height = 7, units = "cm", dpi = 300, device = "pdf")
