...
perch_control_plot_habitats <- generate_ud_plot_whabitats(
  perch_control_PKDE, cow_bbox_perch, cow_hab_locs)
perch_exposed_plot_habitats <- generate_ud_plot_whabitats(
  perch_mix_PKDE, cow_bbox_perch, cow_hab_locs)

# Roach plots
roach_control_plot_habitats <- generate_ud_plot_whabitats(
  roach_control_PKDE, cow_bbox_roach, cow_hab_locs)
roach_exposed_plot_habitats <- generate_ud_plot_whabitats(
  roach_mix_PKDE, cow_bbox_roach, cow_hab_locs)

#Pike plot
pike_total_plot_habitats <- generate_ud_plot_whabitats(
  pike_total_PKDE, cow_bbox_pike, cow_hab_locs)
...
saveRDS(ind_coefs_perch, paste0(rsf_path, "cow_perch/rsf_habitat_cow_perch_coeffs.rds"))
...
ggsave(paste0(figure_path, "rsf_plots/perch_habitats_rsf_cow.pdf"),
...
saveRDS(ind_coefs_roach, paste0(rsf_path, "cow_roach/rsf_habitat_cow_roach_coeffs.rds"))
...
ggsave(paste0(figure_path, "rsf_plots/roach_habitats_rsf_cow.pdf"),
