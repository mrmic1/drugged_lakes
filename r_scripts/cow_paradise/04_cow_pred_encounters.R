...
cow_roach_pike_pred_int <- 
  cow_roach_pike_pred_int %>%
  left_join(cow_roach_max_encounter_dates %>%
...
cow_perch_pike_pred_int <- 
  cow_perch_pike_pred_int %>%
  left_join(cow_perch_max_encounter_dates %>%
...
saveRDS(cow_pred_events, paste0(enc_path, "cow_possible_pred_events.rds"))
...
cow_roach_daily_encounter_summary <-
  roach_pike_encounter_sum %>%
...
head(cow_roach_encounter_summary)


# Save the unfiltered encounter summary
saveRDS(cow_roach_encounter_summary, paste0(enc_path, 'cow_roach_encounter_summmary_unfiltered.rds'))
...
# Save the unfiltered encounter summary
saveRDS(daily_encounter_sum_roach_not_found, paste0(enc_path, 'cow_daily_encounter_summaries_for_roach_not_found.rds'))
...
saveRDS(encounter_sum_roach_not_found, paste0(enc_path, 'cow_total_encounter_summary_for_roach_not_found.rds'))
...
cow_perch_daily_encounter_summary <-
  perch_pike_encounter_sum %>%
...
head(cow_perch_encounter_summary)


# Save the unfiltered encounter summary
saveRDS(cow_perch_encounter_summary, paste0(enc_path, 'cow_perch_encounter_summmary_unfiltered.rds'))
...
# Save the unfiltered encounter summary
saveRDS(daily_encounter_sum_perch_not_found, paste0(enc_path, 'cow_daily_encounter_summaries_for_perch_not_found.rds'))
...
saveRDS(encounter_sum_perch_not_found, paste0(enc_path, 'cow_total_encounter_summary_for_perch_not_found.rds'))
...
saveRDS(encounters_sum_IDs_not_found, paste0(enc_path, 'cow_sum_IDS_not_found.rds'))
...
save_as_docx(daily_irregular_sample_table, 
             path = paste0(save_tables_path, "cow_IDs_not_found_encounter and tracking_summary.docx"))

saveRDS(encounters_sum_IDs_not_found, paste0(enc_path, "cow_encounter_summary_IDs_not_found"))
