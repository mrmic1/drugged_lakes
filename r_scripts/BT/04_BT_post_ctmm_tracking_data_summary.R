...
date_range <- range(BT_filt_data$date, na.rm = TRUE)
...
save_as_docx(
  positions_sum_table,
  path = paste0(save_tables_path, "BT_ID_posititions_sum_unfilt.docx")
)
...
colnames(BT_filt_data)
saveRDS(BT_filt_data, paste0(filtered_data_path, "04_BT_sub.rds"))
