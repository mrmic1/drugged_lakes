#------------------------------------------------------#
# Create temporal dataframes and CTMM objects - LAKE BT #
#------------------------------------------------------#
...
saveRDS(pike_late_tel, paste0(save_telem_path, "BT/stage/pike_BT_late_tel.rds"))
...
pike_BT_early_ctmm_fits <- 
  foreach(i = 1:length(pike_early_tel), .packages = 'ctmm') %dopar% {
    ...
    saveRDS(model_fit, file = paste0(save_ctmm_path, "lake_BT_pike_fits/stage/", names(pike_early_tel)[i], "_early.rds"))
...
pike_BT_late_ctmm_fits <- 
  foreach(i = 1:length(pike_late_tel), .packages = 'ctmm') %dopar% {
    ...
    # Save the fitted model for each fish individually
    saveRDS(model_fit, file = paste0(save_ctmm_path, "lake_BT_pike_fits/stage/", names(pike_late_tel)[i], "_late.rds"))
...
#save telemetry objects
saveRDS(perch_early_tel, paste0(save_telem_path, "BT/stage/perch_BT_early_tel.rds"))
saveRDS(perch_late_tel, paste0(save_telem_path, "BT/stage/perch_BT_late_tel.rds"))


### CTMM Model Fitting ###
#load telemetry models
perch_early_tel <- readRDS(paste0(save_telem_path, "BT/stage/perch_BT_early_tel.rds"))
perch_late_tel <- readRDS(paste0(save_telem_path, "BT/stage/perch_BT_late_tel.rds"))
...
perch_BT_early_ctmm_fits <- 
  foreach(i = 1:length(perch_early_tel), .packages = 'ctmm') %dopar% {
    ...
    # Save the fitted model for each fish individually
    saveRDS(model_fit, file = paste0(save_ctmm_path, "lake_BT_perch_fits/stage/", names(perch_early_tel)[i], "_early.rds"))
...
perch_BT_late_ctmm_fits <- 
  foreach(i = 1:length(perch_late_tel), .packages = 'ctmm') %dopar% {
    ...
    # Save the fitted model for each fish individually
    saveRDS(model_fit, file = paste0(save_ctmm_path, "lake_BT_perch_fits/stage/", names(perch_late_tel)[i], "_late.rds"))
...
#save telemetry objects
saveRDS(roach_early_tel, paste0(save_telem_path, "BT/stage/roach_BT_early_tel.rds"))
saveRDS(roach_late_tel, paste0(save_telem_path, "BT/stage/roach_BT_late_tel.rds"))

### CTMM Model Fitting ###

#load telemetry models
roach_early_tel <- readRDS(paste0(save_telem_path, "BT/stage/roach_BT_early_tel.rds"))
roach_late_tel <- readRDS(paste0(save_telem_path, "BT/stage/roach_BT_late_tel.rds"))
...
roach_BT_early_ctmm_fits <- 
  foreach(i = 1:length(roach_early_tel), .packages = 'ctmm') %dopar% {
    ...
    # Save the fitted model for each fish individually
    saveRDS(model_fit, file = paste0(save_ctmm_path, "lake_BT_roach_fits/stage/", names(roach_early_tel)[i], "_early.rds"))
...
roach_BT_late_ctmm_fits <- 
  foreach(i = 1:length(roach_late_tel), .packages = 'ctmm') %dopar% {
    ...
    # Save the fitted model for each fish individually
    saveRDS(model_fit, file = paste0(save_ctmm_path, "lake_BT_roach_fits/stage/", names(roach_late_tel)[i], "_late.rds"))
